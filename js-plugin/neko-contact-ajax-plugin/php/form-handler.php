...
$to = "davidsontutor@gmail.com";
$subject = "DavidsonTutor Contact Form";
...
if ($errors) {
    ...
    if(mail($to, $subject, $mailBody, $headers)){
        echo '<div class="alert alert-success">Success! Audrey will contact you within two business days.</div>';
    }
}
